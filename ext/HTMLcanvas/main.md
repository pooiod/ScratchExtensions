...
If you want a more in-depth way to debug your html, you can try using inspect element.
You can use eather your default browser inspector, or click the provided toggle button to use a trimmed down version.

> Both can also run custom scripts in the "Console" tab, but the one provided by the extension only shows it if you have scripts enabled.
