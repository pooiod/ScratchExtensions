...
If you want a more in-depth way to debug your html, try using inspect element.
You can eather use your default browser inspector, or click the provided toggle button to use a trimmed down version.

> Both can also run custom scripts in the "Console" tab, but the togglable inspector provided by me only shows it if you have scripts enabled.
