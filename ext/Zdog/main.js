...
(function (Scratch) {
    ...
    class Zdoggy {
        constructor() {
            ...
            this.renderer = new Zdog.Illustration({
                element: this.renders.canvas,
                dragRotate: false,
                resize: true
            });

            this.world['world'] = this.renderer;

            this.parentStack = [this.renderer];
        ...
        getRender({ TYPE, WIDTH, HEIGHT }) {
            ...
            this.renderer.updateRenderGraph();
        ...
        setWorldRotation({ ROT }) {
            this.renderer.rotate.set(this._parseVector(ROT));
        }
