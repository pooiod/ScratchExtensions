// Archival of Griffpatch's Box2D physics extension (for ScratchX) but remade to be compatable with Turbowarp that keeps as close to the originl as possible
...
(function (ext) {
	...
	ext.setBodyDamp = function(bodyIDs, val) {
		ext.setBodyAttr("damping", bodyIDs, val);
	}
    ...
    var descriptor = {
        blocks: [
			...
			['',  'Set damping  of body %s to %n',						      		'setBodyDamp', 'name', '0.1'],
  ...
  /* Incoming ugly hack to get this working in scratch3
   \\ 
