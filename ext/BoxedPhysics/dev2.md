...
### Scene Types
The scene determines the containment type for your physics world:
...
Destroy every object :: #2cb0c0 // Includes joints
```
...
Set an object's velocity or apply forces for dynamic movement.
```scratch3
...
## Performance Options
Optimize your simulation by configuring iteration settings:
```scratch3
...
## Math Utilities
Boxed Physics includes math blocks for convenience:
